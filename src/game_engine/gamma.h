 ...
 * @return wskaźnik na utworzoną strukturę lub `NULL`, jeśli się nie powiodło.
 */
extern gamma_t *gamma_new(uint32_t width, uint32_t height,
 ...
 */
extern bool gamma_golden_move(gamma_t *g, uint32_t player,
